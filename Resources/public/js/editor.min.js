...
var typesSelectbox={template:'<select v-bind:value="value" v-on:change="updateValue($event.target.value)" v-model="selected"><option v-for="type in types" :value="type.name">{{ type.name }}</option></select>',props:["value"],data:function(){return{selected:this.value,types:[]}},mixins:[httpMixin],mounted:function(){this.getExtraFormTypes()},watch:{value:{handler:function(e){this.selected=e}}},methods:{updateValue:function(e){this.$emit("input",e)},getExtraFormTypes:function(){var e=this.$store.getters.extraFormTypesApiUrl,t=this;this.handleGetRequest(e,function(e){t.types=e.filter(function(e){return!1===e["abstract"]}),"initial"===t.selected&&(t.selected=t.types[0].name),t.$emit("input",t.selected)})}}};
...
var editorAdvancedNewFieldConstraint={template:'<div class="new-field-constraint"><multiselect v-model="selectedConstraint" :options="constraints" label="description" key="name" selectLabel="" placeholder="Select a constraint"></multiselect><button class="extra-btn" @click.prevent="createConstraint">Add</button></div>',mixins:[httpMixin],data:function(){return{constraints:[],selectedConstraint:"initial"}},created:function(){this.getExtraFormConstraints()},methods:{createConstraint:function(){var t={extra_form_constraint:this.selectedConstraint.name,options:{}};this.$emit("created",t)},getExtraFormConstraints:function(){var t=this.$store.getters.extraFormConstraintsApiUrl,e=this;this.handleGetRequest(t,function(t){e.constraints=Object.keys(t).map(function(e){return t[e].name=e,t[e]}),e.selectedConstraint=e.constraints[0]})}}};
var editorAdvancedFieldConstraintOptions={template:'<div class="field-constraint-options"><a role="button" data-toggle="collapse" :href="\'#\' + id">Options<span class="toggle"></span></a><div :id="id" class="panel-collapse collapse" role="tabpanel" aria-expanded="false" :aria-controls="id"><component :is="option.component_name" v-for="(option, key) in constraint.extra_form_options" :option="option" :name="key" :value="fieldConstraint.options[key]" @changed="updateOption"/></div></div>',props:["fieldConstraint","index"],data:function(){return{constraint:{}}},computed:{id:function(){return"constraint_"+generateUniqueId()}},watch:{fieldConstraint:{handler:function(t){this.setConstraintOptions(t)}}},components:{"option-checkbox":checkboxOption,"option-textarea":textareaOption,"option-choice":choiceOption,"option-text":textOption,"option-number":numberOption},mixins:[httpMixin],created:function(){this.setConstraintOptions(this.fieldConstraint)},methods:{updateOption:function(t){t.constraint_index=this.index,this.$set(this.fieldConstraint.options,t.name,t.value)},setConstraintOptions:function(t){var n=this.$store.getters.extraFormConstraintsApiUrl,o=this;this.handleGetRequest(n,function(n){o.constraint=n[t.extra_form_constraint];var i=o.constraint.extra_form_options;for(var e in i)i.hasOwnProperty(e)&&(i[e].component_name="option-"+i[e].extra_form_type)})}}};
...
var basicExtraFormType={template:'<div><button class="extra-btn" @click="createField(type)" :class="type.name" type="button"><i :class="getFontAwsomeIconClass(type.icon)" aria-hidden="true"></i>{{ type.name }}</button></div>',props:["type"],mixins:[fontAwesomeIconMixin],methods:{createField:function(e){this.$emit("created",e)}}};
var extraFormTypes={template:'<div><div><ul class="nav nav-pills" role="tablist"><li role="presentation" class="active"><a role="tab" data-toggle="tab" :href="anchor(\'#\', \'basic_types\')">Basic types</a></li><li role="presentation"><a role="tab" data-toggle="tab" :href="anchor(\'#\', \'configured_types\')">Configured types</a></li></ul><div class="tab-content"><div role="tabpanel" class="tab-pane in active" :id="anchor(\'\', \'basic_types\')"><basic-extra-form-type @created="createField" :type="basicType" v-for="basicType in basicTypes"></basic-extra-form-type></div><div role="tabpanel" class="tab-pane" :id="anchor(\'\', \'configured_types\')"><configured-extra-form-type @delete="deleteConfiguredType" @created="createConfiguredField" :type="configuredType" v-for="configuredType in configuredTypes"> </configured-extra-form-type></div></div></div></div>',data:function(){return{modal:{show:!1},editorId:this.$store.getters.editorId}},computed:{configuredTypes:function(){return this.$store.getters.getConfiguredTypes},basicTypes:function(){return this.$store.getters.getTypes}},components:{"configured-extra-form-type":configuredExtraFormType,"basic-extra-form-type":basicExtraFormType},mixins:[httpMixin,fontAwesomeIconMixin,fieldsMixin],created:function(){this.getExtraFormTypes(),this.getConfiguredExtraFormTypes()},methods:{anchor:function(e,t){return e+t+"_"+this.editorId},createField:function(e){var t={name:"field_"+e.name+"_"+generateUniqueId(),icon:e.icon,extra_form_type:e.name,options:{},constraints:[]};this.$emit("created",t)},deleteConfiguredType:function(e){this.$http["delete"](this.$store.getters.deleteConfiguredExtraForTypesApiUrl(e.name)).then(function(){for(var t=0,r=this.configuredTypes.length;t<r;t++)if(this.configuredTypes[t].name===e.name)return void this.$store.commit("removeConfiguredType",t)})},createConfiguredField:function(e){var t={};for(var r in e.extra_form_options)e.extra_form_options.hasOwnProperty(r)&&"undefined"!=typeof e.extra_form_options[r].options.data&&(t[r]=e.extra_form_options[r].options.data);var i={name:"field_"+e.name+"_"+generateUniqueId(),icon:e.icon,extra_form_type:e.form_type_name,options:t,constraints:e.extra_form_constraints};"undefined"!=typeof i.options.configuration&&(i.options.configuration=this.createFieldsRecursively(JSON.parse(i.options.configuration))),this.$emit("created",i)},getExtraFormTypes:function(){var e=this.$store.getters.extraFormTypesApiUrl,t=this;this.handleGetRequest(e,function(e){var r=e.filter(function(e){return!1===e["abstract"]});t.$store.commit("setTypes",r)})},getConfiguredExtraFormTypes:function(){var e=this.$store.getters.configuredExtraFormTypesApiUrl,t=this;this.handleGetRequest(e,function(e){for(var r=0,i=e.length;r<i;r++)"string"==typeof e[r].configuration&&(e[r].configuration=JSON.parse(e[r].configuration)),e[r].extra_form_options.length<1&&(e[r].extra_form_options={});t.$store.commit("setConfiguredTypes",e)})}}};
