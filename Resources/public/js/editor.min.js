...
function filterObject(e,t){var r={};for(var n in e)e.hasOwnProperty(n)&&t(e[n])&&(r[n]=e[n]);return r}function sortObject(e,t,r){const n={};"undefined"==typeof r&&(r=!0),"undefined"==typeof t&&(t=[]);for(var a=0,o=t.length;a<o;a++){var i=t[a];n[i]=e[i]}if(r)Object.keys(e).sort().forEach(function(r){t.indexOf(r)===-1&&(n[r]=e[r])});else for(var i in e)e.hasOwnProperty(i)&&t.indexOf(i)===-1&&(n[i]=e[i]);return n}function generateUniqueId(){return Math.random().toString(36).substr(2,9)}function getLastKey(e){var t=Object.keys(e),r=t.length-1;return t[r]}function hashCode(e){var t,r=0;if(0===e.length)return r;for(var n=0;n<e.length;n++)t=e.charCodeAt(n),r=(r<<5)-r+t,r|=0;return r}function createAttributeMapObject(e){for(var t,r=e.attributes,n={},a=0,o=r.length;a<o;a++)t=r[a],n[t.nodeName]=t.nodeValue;return n.value=e.value,n}function createBootstrapModal(e,t,r,n,a,o){var i=o?o:"";return'<div id="'+t+"-"+e+'" class="editor-modal modal fade '+r+" "+t+'"><div class="modal-dialog" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title">'+n+'</h4></div><div class="modal-body">'+a+'</div><div class="modal-footer">'+i+"</div></div></div></div>"}function jsonifyTwigStrings(e){function t(e){return e.replace(/\\'/g,"\\\\'").replace(/\\"/g,'\\\\"')}var r=/{{.*}}/g;return e.replace(r,t)}function twigifyJsonString(e){function t(e){return e.replace(/\\\\'/g,"\\'").replace(/\\\\"/g,'\\"')}var r=/{{.*}}/g;return e.replace(r,t)}
...
var jsonOptionMixin={mixins:[optionMixin],data:function(){return{classes:""}},created:function(){"object"!=typeof this.value&&"array"!=typeof this.value||(this.data=twigifyJsonString(JSON.stringify(this.value,null,4)),this.setJsonAttemptClass(this.data))},watch:{value:{handler:function(t){"object"!=typeof t&&"array"!=typeof t||(this.data=twigifyJsonString(JSON.stringify(this.value,null,4)),this.setJsonAttemptClass(this.data))}}},methods:{onOptionValueChanged:function(t){this.updateOption(t),this.setJsonAttemptClass(t)},setJsonAttemptClass:function(t){if(0===t.indexOf("{")||0===t.indexOf("["))try{JSON.parse(jsonifyTwigStrings(t)),this.classes="fa fa-check success feedback"}catch(s){this.classes="fa fa-exclamation-circle warning feedback"}else this.classes=""}}};
...
Vue.component("form-editor-raw",{template:'<div><textarea :data-textarea-id="textarea.id" v-model="raw" :name="textarea.name" style="width: 100%; height: 300px;"></textarea><div class="json-errors"></div><button @click.prevent="generateFields">Fill the visual mode form fields from this json</button></div>',props:["fields"],data:function(){return{raw:"",textarea:this.$store.state.formProperties}},mixins:[rawMixin],created:function(){""!==this.textarea.value&&(this.raw=this.textarea.value,this.generateFields())},watch:{fields:{handler:function(e){this.raw=this.generateRaw(e),this.updateInitialTextareaValue()},deep:!0}},methods:{updateInitialTextareaValue:function(){this.textarea.id&&(document.getElementById(this.textarea.id).value=this.raw)},generateFields:function(e){var t=[];try{var a=JSON.parse(jsonifyTwigStrings(this.raw));t=this.createFieldsRecursively(a),this.$emit("generated",t),this.closeModal(e)}catch(r){this.displayJsonParseErrors(e,r)}},generateRaw:function(e){var t=this.createExtraFormRawRecursively(e);return twigifyJsonString(JSON.stringify(t,null,4))},closeModal:function(e){"undefined"!=typeof e&&($(e.target).closest(".modal").modal("hide"),$(e.target).siblings(".json-errors").empty())},displayJsonParseErrors:function(e,t){"undefined"!=typeof e&&$(e.target).siblings(".json-errors").text("There are errors in your json : "+t)}}});
...
window.loadExtraFormEditors=function(){$("textarea.extra-form-editor").each(function(o){function e(){var o=$(".editor-simple");o.on("click",".field-options > label",function(o){o.stopImmediatePropagation(),$(this).parent().toggleClass("show")}),o.on("click",".field-constraint-options > label",function(o){o.stopImmediatePropagation(),$(this).parent().toggleClass("show")})}function a(){$(document).on("change",'.extra-form-inputs-required input[required="required"]',function(){$(this).val()?$(this).css({"border-color":"#cccccc","background-color":"#ffffff"}):$(this).css({"border-color":"#c9302c","background-color":"#f3d9d9"})})}function t(o,e){$(document).on("click","button.trigger-"+o+"-"+e,function(a){a.preventDefault();var t=$("#"+o+"-"+e);"overview-modal"!==o&&(t=t.first()),t.modal("show")})}function i(o){var e="."+o+" .modal-body button.close-modal, ."+o+" .modal-footer > button.close-modal, ."+o+" .modal-header > button.close";$(document).on("click",e,function(o){o.preventDefault(),$(this).closest(".modal").modal("hide")})}function d(e){function a(a){var t=$("#raw-mode-modal-"+o+" textarea").first().val(),i=$.ajax({url:e,method:"POST",data:{overview:{configuration:t}}});i.done(function(o){return a({success:!0,data:o})}),i.fail(function(o){return a({success:!1,data:o})})}$(document).on("click","button.trigger-overview-modal-"+o,function(){setTimeout(function(){a(function(e){e.success?$("#overview-modal-"+o+" .modal-body").replaceWith('<div class="modal-body">'+e.data+"</div>"):$("#overview-modal-"+o+" .modal-body").replaceWith('<div class="modal-body"><div>'+e.data.responseText+"</div></div>")})},800)})}function r(){$(document).on("click","#overview-modal-"+o+" form button[type='submit']",function(e){e.preventDefault(),l(o);var a=$(this).closest("form");setTimeout(function(){c(a,function(e){e.success?e.data&&$("#overview-modal-"+o+" .modal-body").replaceWith('<div class="modal-body">'+e.data+"</div>"):$("#overview-modal-"+o+" .modal-body").replaceWith('<div class="modal-body"><div>'+e.data.responseText+"</div></div>")})},800)})}function n(){$(document).on("hidden.bs.modal","#overview-modal-"+o,function(){l(o)})}function l(){$("#overview-modal-"+o+" .modal-body").replaceWith('<div class="modal-body"><div style="text-align: center;"><i class="fa fa-cog fa-spin fa-3x fa-fw"></i></div></div>')}function c(o,e){var a=$.ajax({url:o.attr("action"),method:o.attr("method"),data:o.serialize()});a.done(function(o){return e({success:!0,data:o})}),a.fail(function(o){return e({success:!1,data:o})})}function s(){return createBootstrapModal(o,"raw-mode-modal","modal-fullscreen","Editor in raw mode",'<form-editor-raw :fields="fields" @generated="updateFields"></form-editor-raw><br>')}function m(){return createBootstrapModal(o,"simple-visual-mode-modal","modal-fullscreen","Simple visual mode",'<form-editor-simple :fields="fields"></form-editor-simple>',"<em>All your changes are automatically saved</em>")}function u(){return createBootstrapModal(o,"advanced-visual-mode-modal","modal-fullscreen","Advanced visual mode",'<form-editor-advanced :fields="fields"></form-editor-advanced>','<button class="btn btn-primary trigger-overview-modal-'+o+'">Display the overview <i class="fa fa-eye"></i></button><em>All your changes are automatically saved</em>')}function f(){return createBootstrapModal(o,"overview-modal","extra-form-inputs-required","Overview",'<div style="text-align: center;"><i class="fa fa-cog fa-spin fa-3x fa-fw"></i></div>')}var v="editorComponent"+o;if(!document.getElementById(v)){var p=createAttributeMapObject(this),b=p["data-available-modes"].split("__"),g=window[p["data-configuration-variable"]],w=s(o),h='<button class="trigger-raw-mode-modal-'+o+'">Raw mode</button>',y="",x="",k="",E="",_="";b.indexOf("simple")>-1&&(y=m(o),x='<button class="trigger-simple-visual-mode-modal-'+o+'">Simple visual mode</button>'),b.indexOf("advanced")>-1&&(k=u(o),E=f(o),_='<button class="trigger-advanced-visual-mode-modal-'+o+'">Advanced visual mode</button>'),$(this).after('<div class="modal-buttons">'+x+" "+_+" "+h+"</div>");var A=$("body");A.append('<div id="'+v+'">'+w+y+k+E+"</div>"),this.style.display="none";var B=["simple-visual-mode-modal","advanced-visual-mode-modal","raw-mode-modal","overview-modal"];B.forEach(function(e){t(e,o)}),B.forEach(function(o){i(o)}),d(g.extra_form_editor_overview_url,o),n(o),r(o),a(),e(),triggerVueEditor("#"+v,p,g)}})};