...
function filterObject(t,r){var e={};for(var n in t)t.hasOwnProperty(n)&&r(t[n])&&(e[n]=t[n]);return e}function generateUniqueId(){return Math.random().toString(36).substr(2,9)}function createAttributeMapObject(t){for(var r,e=t.attributes,n={},a=0,u=e.length;a<u;a++)r=e[a],n[r.nodeName]=r.nodeValue;return n}
var optionMixin={props:["option","name","value"],data:function(){return{data:this.option.options.data}},created:function(){"undefined"!=typeof this.value&&(this.data=this.value)},methods:{updateOption:function(t){this.data=t,this.$emit("changed",{name:this.name,value:t})},setJsonAttemptClass:function(t){if(t.indexOf("{")!==-1||t.indexOf("[")!==-1)try{JSON.parse(t),this.classes="fa fa-check success feedback"}catch(a){this.classes="fa fa-exclamation-circle warning feedback"}else this.classes=""}}};
var httpMixin={methods:{handleGetRequest:function(t,e){var n=this.$store.getters.getCachedResource(t);return n?e(n):void this.$http.get(t).then(function(t){return t.json()},function(t){console.log(t.status+" "+t.statusText)}).then(function(n){return this.$store.commit({type:"cache",api_url:t,api_response:n}),e(n)})}}};
...
var fieldsMixins={methods:{createFieldsRecursively:function(i){var n=[],o=0;for(var t in i)if(o+=1,i.hasOwnProperty(t)){var e={name:i[t].name,extra_form_type:i[t].extra_form_type,options:i[t].options,constraints:i[t].constraints};e.active=1===o,"undefined"!=typeof i[t].options.configuration&&(e.options.configuration=this.createFieldsRecursively(i[t].options.configuration)),n.push(e)}return n}}};
...
var extraFormTypes={template:'<div><div><ul class="nav nav-pills" role="tablist"><li role="presentation" class="active"><a role="tab" data-toggle="tab" href="#basic-types">Basic types</a></li><li role="presentation"><a role="tab" data-toggle="tab" href="#configured-types">Configured types</a></li></ul><div class="tab-content"><div role="tabpanel" class="tab-pane in active" id="basic-types"><basic-extra-form-type @created="createField" :type="basicType" v-for="basicType in basicTypes"></basic-extra-form-type></div><div role="tabpanel" class="tab-pane" id="configured-types"><configured-extra-form-type @delete="deleteConfiguredType" @created="createConfiguredField" :type="configuredType" v-for="configuredType in configuredTypes"> </configured-extra-form-type></div></div></div></div>',data:function(){return{modal:{show:!1}}},computed:{configuredTypes:function(){return this.$store.getters.getConfiguredTypes},basicTypes:function(){return this.$store.getters.getTypes}},components:{"configured-extra-form-type":configuredExtraFormType,"basic-extra-form-type":basicExtraFormType},mixins:[httpMixin,fontAwesomeIconMixin,fieldsMixins],created:function(){this.getExtraFormTypes(),this.getConfiguredExtraFormTypes()},methods:{createField:function(e){var t={name:"field_"+e.name+"_"+generateUniqueId(),icon:e.icon,extra_form_type:e.name,options:{},constraints:[]};this.$emit("created",t)},deleteConfiguredType:function(e){this.$http["delete"](this.$store.getters.deleteConfiguredExtraForTypesApiUrl(e.name)).then(function(){for(var t=0,i=this.configuredTypes.length;t<i;t++)if(this.configuredTypes[t].name===e.name)return void this.$store.commit("removeConfiguredType",t)},function(e){})},createConfiguredField:function(e){var t={};for(var i in e.extra_form_options)e.extra_form_options.hasOwnProperty(i)&&"undefined"!=typeof e.extra_form_options[i].options.data&&(t[i]=e.extra_form_options[i].options.data);var r={name:"field_"+e.name+"_"+generateUniqueId(),icon:e.icon,extra_form_type:e.form_type_name,options:t,constraints:e.extra_form_constraints};"undefined"!=typeof r.options.configuration&&(r.options.configuration=this.createFieldsRecursively(JSON.parse(r.options.configuration))),this.$emit("created",r)},getExtraFormTypes:function(){var e=this.$store.getters.extraFormTypesApiUrl,t=this;this.handleGetRequest(e,function(e){var i=e.filter(function(e){return e["abstract"]===!1});t.$store.commit("setTypes",i)})},getConfiguredExtraFormTypes:function(){var e=this.$store.getters.configuredExtraFormTypesApiUrl,t=this;this.handleGetRequest(e,function(e){for(var i=0,r=e.length;i<r;i++)"string"==typeof e[i].configuration&&(e[i].configuration=JSON.parse(e[i].configuration)),e[i].extra_form_options.length<1&&(e[i].extra_form_options={});t.$store.commit("setConfiguredTypes",e)})}}};
...
Vue.component("editor-raw",{template:'<div><textarea :id="textarea.id" v-model="output" :name="textarea.name" style="width: 100%; height: 300px;"></textarea><button class="close-modal" @click.prevent="generateFields">Fill the visual mode form fields from this json</button></div>',props:["fields"],data:function(){return{output:"",textarea:this.$store.state.formProperties}},mixins:[fieldsMixins],created:function(){try{""!==this.textarea.value&&(this.output=this.textarea.value,this.generateFields())}catch(t){console.error("Json parsing error")}},watch:{fields:{handler:function(t){this.output=this.generateOutput(t)},deep:!0}},methods:{generateFields:function(){var t=[];try{var e=JSON.parse(this.output);t=this.createFieldsRecursively(e),this.$emit("generated",t)}catch(r){console.error("Json parsing error")}},generateOutput:function(t){var e=this.createOutputRecursively(t);return JSON.stringify(e,null,4)},createOutputRecursively:function(t){for(var e=JSON.parse(JSON.stringify(t)),r={},i=0,n=e.length;i<n;i++){var o=e[i],a=o.name;r[a]={},r[a].extra_form_type=o.extra_form_type,r[a].constraints=o.constraints;var s=o.options;for(var u in s)if(s.hasOwnProperty(u))try{s[u]=JSON.parse(s[u])}catch(c){}r[a].options=s,"undefined"!=typeof o.options.configuration&&(0===o.options.configuration.length?delete r[a].options.configuration:r[a].options.configuration=this.createOutputRecursively(r[a].options.configuration),r[a].constraints=o.constraints)}return r}}});
function triggerEditor(e,r,n){Vue.component("Multiselect",VueMultiselect["default"]),Vue.use(VueResource);const t=new Vuex.Store({state:{configuration:n,formProperties:r,configuredTypes:[],types:[],apiCache:{}},getters:{configuredFieldEditionAllowed:function(e){return e.configuration.allow_configured_type_edition},configuredExtraFormTypesApiUrl:function(e){return e.configuration.api_url.get_configured_extra_form_types},extraFormTypesApiUrl:function(e){return e.configuration.api_url.get_extra_form_types},postConfiguredExtraFormTypesApiUrl:function(e){return e.configuration.api_url.post_configured_extra_form_types},putConfiguredExtraForTypesApiUrl:function(e){return function(r){return e.configuration.api_url.put_configured_extra_form_types.replace("XNAME",r)}},deleteConfiguredExtraForTypesApiUrl:function(e){return function(r){return e.configuration.api_url.delete_configured_extra_form_types.replace("XNAME",r)}},extraFormTypeOptionsApiUrl:function(e){return function(r){return e.configuration.api_url.get_extra_form_type_options.replace("XTYPE",r)}},extraFormConstraintsApiUrl:function(e){return e.configuration.api_url.get_extra_form_constraints},getCachedResource:function(e){return function(r){return e.apiCache[r]}},getConfiguredTypes:function(e){return e.configuredTypes},getTypes:function(e){return e.types}},mutations:{cache:function(e,r){e.apiCache[r.api_url]=r.api_response},setConfiguredTypes:function(e,r){e.configuredTypes=r},addConfiguredType:function(e,r){e.configuredTypes.push(r)},removeConfiguredType:function(e,r){e.configuredTypes.splice(r,1)},updateConfiguredType:function(e,r){for(var n=0,t=e.configuredTypes.length;n<t;n++)if(e.configuredTypes[n].name===r.name)return e.configuredTypes.splice(n,1),void e.configuredTypes.push(r)},setTypes:function(e,r){e.types=r}}});new Vue({el:e,store:t,data:{fields:[]},mixins:[httpMixin],methods:{updateFields:function(e){this.$set(this,"fields",e)}}})}
$(window).on("load",function(){$("textarea.extra-form-editor").each(function(a){var o=createAttributeMapObject(this);o.value=this.value;var d="editorApp"+a,e=o["data-available-modes"].split("__"),l=window[o["data-configuration-variable"]],i='<div id="modal_raw" class="modal fade modal-fullscreen raw-mode-modal"><div class="modal-dialog" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title">Editor in raw mode</h4></div></div><div class="modal-body"><editor-raw :fields="fields" @generated="updateFields"></editor-raw><br></div><div class="modal-footer"><button class="btn btn-default close-modal">Close the editor <i class="fa fa-times"></i></button></div></div></div>',t='<button class="trigger-raw-mode-modal">Raw mode</button>',s="",n="";e.indexOf("simple")>-1&&(s='<div id="modal_simple" class="modal fade modal-fullscreen simple-visual-mode-modal"><div class="modal-dialog" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title">Simple visual mode</h4></div><div class="modal-body"><editor-simple :fields="fields"></editor-simple></div><div class="modal-footer"><button class="btn btn-default close-modal">Close the editor <i class="fa fa-times"></i></button><em>All your changes are automatically saved</em></div></div></div></div>',n='<button class="trigger-simple-visual-mode-modal">Simple visual mode</button>');var c="",r="",m="";e.indexOf("advanced")>-1&&(c='<div id="modal_advanced" class="modal fade modal-fullscreen advanced-visual-mode-modal"><div class="modal-dialog" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title">Advanced visual mode</h4></div><div class="modal-body"><editor-advanced :fields="fields"></editor-advanced></div><div class="modal-footer"><button class="btn btn-default close-modal">Close the editor <i class="fa fa-times"></i></button><button class="btn btn-primary trigger-overview-modal">Display the overview <i class="fa fa-eye"></i></button><em>All your changes are automatically saved</em></div></div></div></div>',r='<div id="modal_overview" class="modal fade overview-modal"><div class="modal-dialog" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title">Overview</h4></div><div class="modal-body"><div style="text-align: center;"><i class="fa fa-cog fa-spin fa-3x fa-fw"></i></div></div><div class="modal-footer"><button class="btn btn-default close-modal">Close the overview <i class="fa fa-times"></i></button></div></div></div></div>',m='<button class="trigger-advanced-visual-mode-modal">Advanced visual mode</button>'),$(this).replaceWith('<div id="'+d+'" data-configuration-variable="extraFormEditorConfiguration"><div class="modal-buttons">'+n+" "+m+" "+t+" "+r+'</div><br><div class="modals">'+s+c+i+"</div></div>"),triggerEditor("#"+d,o,l)});var a=$(".editor-simple");a.on("click",".field-options > label",function(a){a.stopImmediatePropagation(),$(this).parent().toggleClass("show")}),a.on("click",".field-constraint-options > label",function(a){a.stopImmediatePropagation(),$(this).parent().toggleClass("show")}),$(document).on("change",'input[required="required"]',function(){$(this).val()?$(this).css({"border-color":"#cccccc","background-color":"#ffffff"}):$(this).css({"border-color":"#c9302c","background-color":"#f3d9d9"})});var o=["simple-visual-mode-modal","advanced-visual-mode-modal","raw-mode-modal","overview-modal"];o.forEach(function(a){$(document).on("click","button.trigger-"+a,function(o){o.preventDefault(),"overview-modal"===a?$modal=$("."+a):$modal=$(".modals ."+a).first(),$modal.modal("show")})}),o.forEach(function(a){var o="."+a+" .modal-body button.close-modal, ."+a+" .modal-footer > button.close-modal, ."+a+" .modal-header > button.close";$(document).on("click",o,function(a){a.preventDefault(),$(this).closest(".modal").modal("hide")})})});
var getOverview=function(e){var a=$("#modal_raw textarea").first().val(),o=$.ajax({url:"/extra-form/overview",method:"POST",data:{configuration:a}});o.done(function(a){return e({success:!0,data:a})}),o.fail(function(a){return e({success:!1,data:a})})};$(window).on("load",function(){$(document).on("click","button.trigger-overview-modal",function(){setTimeout(function(){getOverview(function(e){e.success?$("#modal_overview .modal-body div").replaceWith(e.data):$("#modal_overview .modal-body div").replaceWith("<div>"+e.data.responseText+"</div>")})},800)}),$(".overview-modal").on("hidden.bs.modal",function(e){$("#modal_overview .modal-body div").replaceWith('<div style="text-align: center;"><i class="fa fa-cog fa-spin fa-3x fa-fw"></i></div>')})});