...
var optionMixin={props:["option","name","value"],data:function(){return{data:this.option.options.data}},created:function(){"undefined"!=typeof this.value&&(this.data=this.value)},methods:{updateOption:function(t){this.$emit("changed",{name:this.name,value:t})}}};
...
var textareaOption={template:'<div class="form-group"><label :for="name">{{ name }}</label><textarea class="form-control" :required="option.options.required" :value="data" @input="updateOption($event.target.value)" :name="name"></textarea></div>',mixins:[optionMixin]};
...
var textOption={template:'<div class="form-group"><label :for="name">{{ name }}</label><input class="form-control" :required="option.options.required" :value="data" @input="updateOption($event.target.value)" type="text" :name="name"></div>',mixins:[optionMixin]};
