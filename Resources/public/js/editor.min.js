...
function filterObject(e,t){var r={};for(var n in e)e.hasOwnProperty(n)&&t(e[n])&&(r[n]=e[n]);return r}function sortObject(e,t,r){const n={};"undefined"==typeof r&&(r=!0),"undefined"==typeof t&&(t=[]);for(var o=0,a=t.length;o<a;o++){var i=t[o];n[i]=e[i]}if(r)Object.keys(e).sort().forEach(function(r){t.indexOf(r)===-1&&(n[r]=e[r])});else for(var i in e)e.hasOwnProperty(i)&&t.indexOf(i)===-1&&(n[i]=e[i]);return n}function generateUniqueId(){return Math.random().toString(36).substr(2,9)}function getLastKey(e){var t=Object.keys(e),r=t.length-1;return t[r]}function hashCode(e){var t,r=0;if(0===e.length)return r.toString();for(var n=0;n<e.length;n++)t=e.charCodeAt(n),r=(r<<5)-r+t,r|=0;return r.toString()}function createAttributeMapObject(e){for(var t,r=e.attributes,n={},o=0,a=r.length;o<a;o++)t=r[o],n[t.nodeName]=t.nodeValue;return n.value=e.value,n}function createBootstrapModal(e,t,r,n,o,a){var i=a?a:"";return'<div id="'+t+"-"+e+'" class="editor-modal modal fade '+r+" "+t+'"><div class="modal-dialog" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title">'+n+'</h4></div><div class="modal-body">'+o+'</div><div class="modal-footer">'+i+"</div></div></div></div>"}function colorEmptyRequiredInputs(e,t){function r(e){e.val()?e.css({"border-color":"#cccccc","background-color":"#ffffff"}):e.css({"border-color":"#c9302c","background-color":"#f3d9d9"})}var n="."+t+' input[required="required"]';$(document).on("change",n,function(){r($(this))});var o=document.getElementById(e),a={childList:!0,characterData:!0,subtree:!0},i=new MutationObserver(function(e){e.forEach(function(e){var o=[];o=$(e.target).hasClass(t)?$(e.target).find('input[required="required"]'):$(e.target).find(n),o.each(function(){r($(this))})})});i.observe(o,a)}String.prototype.removeLineBreaksAnsExtraSpaces=function(){return this.replace(/\r?\n|\r/g," ").replace(/ {2,}/g," ")};
JsonToTwigTransformer={toJson:function(e){function r(e){return e.replace(/\\/g,"\\\\").replace(/"/g,'\\"')}function a(e){var r=e.removeLineBreaksAnsExtraSpaces().replace(/([^\\])"/g,'$1\\"');return localStorage.setItem(hashCode(r),e),r}function n(e,r,a,n){return r+': "'+n+'"'}var t=/{{(.*)?}}/g,c=/\[(\s{0,}){%([\s\S]*.*)%}(\s{0,})\]/g,o=/("([\w.|]*)"): (\[(\s{0,}){%([\s\S]*.*)%}(\s{0,})\])/g;return e.replace(t,r).replace(c,a).replace(o,n)},toRaw:function(e){function r(e){return e.replace(/\\\\/g,"\\").replace(/\\"/g,'"')}function a(e){var r=e.substring(1,e.length-1);return null!==localStorage.getItem(hashCode(r))?localStorage.getItem(hashCode(r)):r.replace(/\\"/g,'"').replace(/\\\\'/g,"\\'")}var n=/{{(.*)?}}/g,t=/"\[( {0,1}){%(.*)%}( {0,1})\]"/g;return e.replace(t,a).replace(n,r)}};
...
var jsonOptionMixin={mixins:[optionMixin],data:function(){return{classes:""}},created:function(){"object"==typeof this.value&&(this.data=JsonToTwigTransformer.toRaw(JSON.stringify(this.value,null,4)),this.setJsonAttemptClass(this.data))},watch:{value:{handler:function(t){"object"==typeof t&&(this.data=JsonToTwigTransformer.toRaw(JSON.stringify(t,null,4)),this.setJsonAttemptClass(this.data))}}},methods:{onOptionValueChanged:function(t){this.updateOption(t),this.setJsonAttemptClass(t)},setJsonAttemptClass:function(t){if(0===t.indexOf("{{")||0!==t.indexOf("{")&&0!==t.indexOf("["))this.classes="";else try{JSON.parse(JsonToTwigTransformer.toJson(t)),this.classes="fa fa-check success feedback"}catch(s){this.classes="fa fa-exclamation-circle warning feedback"}}}};
