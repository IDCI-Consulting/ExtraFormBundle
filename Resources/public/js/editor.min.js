...
function showModalOnClick(e,o){$(document).on("click","button.trigger-"+e+"-"+o,function(a){a.preventDefault();var d=$("#"+e+"-"+o);"overview-modal"!==e&&(d=d.first()),d.modal("show")})}function hideModalOnClick(e){var o="."+e+" .modal-body button.close-modal, ."+e+" .modal-footer > button.close-modal, ."+e+" .modal-header > button.close";$(document).on("click",o,function(e){e.preventDefault(),$(this).closest(".modal").modal("hide")})}function getFormOverviewOnClick(e,o){function a(a){var d=$("#raw-mode-modal-"+o+" textarea").first().val(),i=$.ajax({url:e,method:"POST",data:{overview:{configuration:d}}});i.done(function(e){return a({success:!0,data:e})}),i.fail(function(e){return a({success:!1,data:e})})}$(document).on("click","button.trigger-overview-modal-"+o,function(){setTimeout(function(){a(function(e){e.success?$("#overview-modal-"+o+" .modal-body").replaceWith('<div class="modal-body">'+e.data+"</div>"):$("#overview-modal-"+o+" .modal-body").replaceWith('<div class="modal-body"><div>'+e.data.responseText+"</div></div>")})},800)})}function submitFormOverviewOnClick(e){$(document).on("click","#overview-modal-"+e+" form button",function(o){o.preventDefault(),resetFormOverviewModal(e);var a=$(this).closest("form");setTimeout(function(){submitForm(a,function(o){o.success?o.data&&$("#overview-modal-"+e+" .modal-body").replaceWith('<div class="modal-body">'+o.data+"</div>"):$("#overview-modal-"+e+" .modal-body").replaceWith('<div class="modal-body"><div>'+o.data.responseText+"</div></div>")})},800)})}function resetFormOverviewModalOnClose(e){$(document).on("hidden.bs.modal","#overview-modal-"+e,function(){resetFormOverviewModal(e)})}function resetFormOverviewModal(e){$("#overview-modal-"+e+" .modal-body").replaceWith('<div class="modal-body"><div style="text-align: center;"><i class="fa fa-cog fa-spin fa-3x fa-fw"></i></div></div>')}function createModal(e,o,a,d,i,t){var l=a?"modal-fullscreen":"",r=t?t:"";return'<div id="'+o+"-"+e+'" class="modal fade '+l+" "+o+'"><div class="modal-dialog" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title">'+d+'</h4></div><div class="modal-body">'+i+'</div><div class="modal-footer">'+r+"</div></div></div></div>"}function createRawModal(e){return createModal(e,"raw-mode-modal",!0,"Editor in raw mode",'<editor-raw :fields="fields" @generated="updateFields"></editor-raw><br>')}function createSimpleModal(e){return createModal(e,"simple-visual-mode-modal",!0,"Simple visual mode",'<editor-simple :fields="fields"></editor-simple>',"<em>All your changes are automatically saved</em>")}function createAdvancedModal(e){return createModal(e,"advanced-visual-mode-modal",!0,"Advanced visual mode",'<editor-advanced :fields="fields"></editor-advanced>','<button class="btn btn-primary trigger-overview-modal-'+e+'">Display the overview <i class="fa fa-eye"></i></button><em>All your changes are automatically saved</em>')}function createOverviewModal(e){return createModal(e,"overview-modal",!1,"Overview",'<div style="text-align: center;"><i class="fa fa-cog fa-spin fa-3x fa-fw"></i></div>')}$(window).on("load",function(){$("textarea.extra-form-editor").each(function(e){var o=createAttributeMapObject(this),a="editorComponent"+e,d=o["data-available-modes"].split("__"),i=window[o["data-configuration-variable"]],t=createRawModal(e),l='<button class="trigger-raw-mode-modal-'+e+'">Raw mode</button>',r="",n="",c="",s="",v="";d.indexOf("simple")>-1&&(r=createSimpleModal(e),n='<button class="trigger-simple-visual-mode-modal-'+e+'">Simple visual mode</button>'),d.indexOf("advanced")>-1&&(c=createAdvancedModal(e),s=createOverviewModal(e),v='<button class="trigger-advanced-visual-mode-modal-'+e+'">Advanced visual mode</button>'),$(this).after('<div class="modal-buttons">'+n+" "+v+" "+l+"</div>"),function(){var e=$("body");e.append('<div id="'+a+'">'+t+r+c+s+"</div>")}(),this.style.display="none";var m=["simple-visual-mode-modal","advanced-visual-mode-modal","raw-mode-modal","overview-modal"];m.forEach(function(o){showModalOnClick(o,e)}),m.forEach(function(e){hideModalOnClick(e)}),getFormOverviewOnClick(i.extra_form_editor_overview_url,e),resetFormOverviewModalOnClose(e),submitFormOverviewOnClick(e),triggerExtraFormBundleEditor("#"+a,o,i)});var e=$(".editor-simple");e.on("click",".field-options > label",function(e){e.stopImmediatePropagation(),$(this).parent().toggleClass("show")}),e.on("click",".field-constraint-options > label",function(e){e.stopImmediatePropagation(),$(this).parent().toggleClass("show")}),$(document).on("change",'input[required="required"]',function(){$(this).val()?$(this).css({"border-color":"#cccccc","background-color":"#ffffff"}):$(this).css({"border-color":"#c9302c","background-color":"#f3d9d9"})})});