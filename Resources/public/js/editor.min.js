...
function filterObject(e,t){var r={};for(var n in e)e.hasOwnProperty(n)&&t(e[n])&&(r[n]=e[n]);return r}function generateUniqueId(){return Math.random().toString(36).substr(2,9)}function getLastKey(e){var t=Object.keys(e),r=Object.keys(e).length-1;return t[r]}function createAttributeMapObject(e){for(var t,r=e.attributes,n={},a=0,u=r.length;a<u;a++)t=r[a],n[t.nodeName]=t.nodeValue;return n.value=e.value,n}
...
window.loadExtraFormEditors=function(){extraQuery("textarea.extra-form-editor").each(function(e){function a(){var e=extraQuery(".editor-simple");e.on("click",".field-options > label",function(e){e.stopImmediatePropagation(),extraQuery(this).parent().toggleClass("show")}),e.on("click",".field-constraint-options > label",function(e){e.stopImmediatePropagation(),extraQuery(this).parent().toggleClass("show")})}function o(){extraQuery(document).on("change",'.extra-form-inputs-required input[required="required"]',function(){extraQuery(this).val()?extraQuery(this).css({"border-color":"#cccccc","background-color":"#ffffff"}):extraQuery(this).css({"border-color":"#c9302c","background-color":"#f3d9d9"})})}function t(e,a){extraQuery(document).on("click","button.trigger-"+e+"-"+a,function(o){o.preventDefault();var t=extraQuery("#"+e+"-"+a);"overview-modal"!==e&&(t=t.first()),t.modal("show")})}function i(e){var a="."+e+" .modal-body button.close-modal, ."+e+" .modal-footer > button.close-modal, ."+e+" .modal-header > button.close";extraQuery(document).on("click",a,function(e){e.preventDefault(),extraQuery(this).closest(".modal").modal("hide")})}function d(a){function o(o){var t=extraQuery("#raw-mode-modal-"+e+" textarea").first().val(),i=extraQuery.ajax({url:a,method:"POST",data:{overview:{configuration:t}}});i.done(function(e){return o({success:!0,data:e})}),i.fail(function(e){return o({success:!1,data:e})})}extraQuery(document).on("click","button.trigger-overview-modal-"+e,function(){setTimeout(function(){o(function(a){a.success?extraQuery("#overview-modal-"+e+" .modal-body").replaceWith('<div class="modal-body">'+a.data+"</div>"):extraQuery("#overview-modal-"+e+" .modal-body").replaceWith('<div class="modal-body"><div>'+a.data.responseText+"</div></div>")})},800)})}function r(){extraQuery(document).on("click","#overview-modal-"+e+" form button[type='submit']",function(a){a.preventDefault(),l(e);var o=extraQuery(this).closest("form");setTimeout(function(){s(o,function(a){a.success?a.data&&extraQuery("#overview-modal-"+e+" .modal-body").replaceWith('<div class="modal-body">'+a.data+"</div>"):extraQuery("#overview-modal-"+e+" .modal-body").replaceWith('<div class="modal-body"><div>'+a.data.responseText+"</div></div>")})},800)})}function n(){extraQuery(document).on("hidden.bs.modal","#overview-modal-"+e,function(){l(e)})}function l(){extraQuery("#overview-modal-"+e+" .modal-body").replaceWith('<div class="modal-body"><div style="text-align: center;"><i class="fa fa-cog fa-spin fa-3x fa-fw"></i></div></div>')}function s(e,a){var o=extraQuery.ajax({url:e.attr("action"),method:e.attr("method"),data:e.serialize()});o.done(function(e){return a({success:!0,data:e})}),o.fail(function(e){return a({success:!1,data:e})})}function c(e,a,o,t,i,d){var r=d?d:"";return'<div id="'+a+"-"+e+'" class="editor-modal modal fade '+o+" "+a+'"><div class="modal-dialog" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title">'+t+'</h4></div><div class="modal-body">'+i+'</div><div class="modal-footer">'+r+"</div></div></div></div>"}function u(){return c(e,"raw-mode-modal","modal-fullscreen","Editor in raw mode",'<editor-raw :fields="fields" @generated="updateFields"></editor-raw><br>')}function m(){return c(e,"simple-visual-mode-modal","modal-fullscreen","Simple visual mode",'<editor-simple :fields="fields"></editor-simple>',"<em>All your changes are automatically saved</em>")}function v(){return c(e,"advanced-visual-mode-modal","modal-fullscreen","Advanced visual mode",'<editor-advanced :fields="fields"></editor-advanced>','<button class="btn btn-primary trigger-overview-modal-'+e+'">Display the overview <i class="fa fa-eye"></i></button><em>All your changes are automatically saved</em>')}function f(){return c(e,"overview-modal","extra-form-inputs-required","Overview",'<div style="text-align: center;"><i class="fa fa-cog fa-spin fa-3x fa-fw"></i></div>')}var y="editorComponent"+e;if(!document.getElementById(y)){var b=createAttributeMapObject(this),p=b["data-available-modes"].split("__"),x=window[b["data-configuration-variable"]],h=u(e),g='<button class="trigger-raw-mode-modal-'+e+'">Raw mode</button>',w="",Q="",k="",E="",_="";p.indexOf("simple")>-1&&(w=m(e),Q='<button class="trigger-simple-visual-mode-modal-'+e+'">Simple visual mode</button>'),p.indexOf("advanced")>-1&&(k=v(e),E=f(e),_='<button class="trigger-advanced-visual-mode-modal-'+e+'">Advanced visual mode</button>'),extraQuery(this).after('<div class="modal-buttons">'+Q+" "+_+" "+g+"</div>");var A=extraQuery("body");A.append('<div id="'+y+'">'+h+w+k+E+"</div>"),this.style.display="none";var O=["simple-visual-mode-modal","advanced-visual-mode-modal","raw-mode-modal","overview-modal"];O.forEach(function(a){t(a,e)}),O.forEach(function(e){i(e)}),d(x.extra_form_editor_overview_url,e),n(e),r(e),o(),a(),triggerVueEditor("#"+y,b,x)}})};