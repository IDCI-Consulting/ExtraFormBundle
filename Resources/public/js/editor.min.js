...
function filterObject(e,t){var r={};for(var n in e)e.hasOwnProperty(n)&&t(e[n])&&(r[n]=e[n]);return r}function sortObject(e,t,r){const n={};"undefined"==typeof r&&(r=!0),"undefined"==typeof t&&(t=[]);for(var o=0,a=t.length;o<a;o++){var c=t[o];n[c]=e[c]}if(r)Object.keys(e).sort().forEach(function(r){t.indexOf(r)===-1&&(n[r]=e[r])});else for(var c in e)e.hasOwnProperty(c)&&t.indexOf(c)===-1&&(n[c]=e[c]);return n}function generateUniqueId(){return Math.random().toString(36).substr(2,9)}function getLastKey(e){var t=Object.keys(e),r=t.length-1;return t[r]}function hashCode(e){var t,r=0;if(0===e.length)return r;for(var n=0;n<e.length;n++)t=e.charCodeAt(n),r=(r<<5)-r+t,r|=0;return r}function createAttributeMapObject(e){for(var t,r=e.attributes,n={},o=0,a=r.length;o<a;o++)t=r[o],n[t.nodeName]=t.nodeValue;return n.value=e.value,n}function createBootstrapModal(e,t,r,n,o,a){var c=a?a:"";return'<div id="'+t+"-"+e+'" class="editor-modal modal fade '+r+" "+t+'"><div class="modal-dialog" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title">'+n+'</h4></div><div class="modal-body">'+o+'</div><div class="modal-footer">'+c+"</div></div></div></div>"}function jsonifyTwigStrings(e){function t(e){return e.replace(/\\'/g,"\\\\'").replace(/\\"/g,'\\\\"')}var r=/{{.*}}/g;return e.replace(r,t)}function twigifyJsonString(e){function t(e){return e.replace(/\\\\'/g,"\\'").replace(/\\\\"/g,'\\"')}var r=/{{.*}}/g;return e.replace(r,t)}function colorEmptyRequiredInputs(e,t){function r(e){e.val()?e.css({"border-color":"#cccccc","background-color":"#ffffff"}):e.css({"border-color":"#c9302c","background-color":"#f3d9d9"})}var n=t+' input[required="required"]';$(document).on("change",n,function(){r($(this))});var o=document.getElementById(e),a={childList:!0,characterData:!0,subtree:!0},c=new MutationObserver(function(e){e.forEach(function(e){$(e.target).find(n).each(function(){r($(this))})})});c.observe(o,a)}
var optionMixin={props:["option","name","value"],data:function(){return{data:this.option.options.data}},created:function(){"undefined"!=typeof this.value&&(this.data=this.value,"string"!=typeof this.value&&(this.data=JSON.stringify(this.value)))},watch:{value:{handler:function(t){"undefined"!=typeof t&&(this.data=t,"string"!=typeof t&&(this.data=JSON.stringify(t)))}}},methods:{updateOption:function(t){"undefined"!=typeof t&&(this.data=t,this.$emit("changed",{name:this.name,value:t}))}}};
var jsonOptionMixin={mixins:[optionMixin],data:function(){return{classes:""}},created:function(){"object"==typeof this.value&&(this.data=twigifyJsonString(JSON.stringify(this.value,null,4)),this.setJsonAttemptClass(this.data))},watch:{value:{handler:function(t){"object"==typeof t&&(this.data=twigifyJsonString(JSON.stringify(t,null,4)),this.setJsonAttemptClass(this.data))}}},methods:{onOptionValueChanged:function(t){this.updateOption(t),this.setJsonAttemptClass(t)},setJsonAttemptClass:function(t){if(0===t.indexOf("{{")||0!==t.indexOf("{")&&0!==t.indexOf("["))this.classes="";else try{JSON.parse(jsonifyTwigStrings(t)),this.classes="fa fa-check success feedback"}catch(s){this.classes="fa fa-exclamation-circle warning feedback"}}}};
...
var rawMixin={methods:{createExtraFormRawRecursively:function(t){for(var n=JSON.parse(JSON.stringify(t)),o={},i=0,r=n.length;i<r;i++){var e=n[i],a=e.name;o[a]={},o[a].extra_form_type=e.extra_form_type,o[a].constraints=e.constraints,o[a].options=this.formatOptions(e.options),"undefined"!=typeof e.options.configuration&&(0===e.options.configuration.length?delete o[a].options.configuration:o[a].options.configuration=this.createExtraFormRawRecursively(o[a].options.configuration),o[a].constraints=e.constraints)}return o},createFieldsRecursively:function(t){var n=[],o=0;for(var i in t)if(t.hasOwnProperty(i)){o+=1;var r="undefined"==typeof t[i].name?i:t[i].name,e={name:r,extra_form_type:t[i].extra_form_type,options:t[i].options,constraints:t[i].constraints};e.active=1===o,"undefined"!=typeof t[i].options.configuration&&(e.options.configuration=this.createFieldsRecursively(t[i].options.configuration)),n.push(e)}return n},formatOptions:function(t){for(var n in t)if(t.hasOwnProperty(n))try{0===t[n].length?delete t[n]:t[n]=JSON.parse(jsonifyTwigStrings(t[n]))}catch(o){}return t}}};
