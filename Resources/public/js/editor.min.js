...
function filterObject(t,e){var a={};for(var r in t)t.hasOwnProperty(r)&&e(t[r])&&(a[r]=t[r]);return a}function generateUniqueId(){return Math.random().toString(36).substr(2,9)}function getLastKey(t){var e=Object.keys(t),a=e.length-1;return e[a]}function hashCode(t){var e,a=0;if(0===t.length)return a;for(var r=0;r<t.length;r++)e=t.charCodeAt(r),a=(a<<5)-a+e,a|=0;return a}function createAttributeMapObject(t){for(var e,a=t.attributes,r={},n=0,o=a.length;n<o;n++)e=a[n],r[e.nodeName]=e.nodeValue;return r.value=t.value,r}function createBootstrapModal(t,e,a,r,n,o){var d=o?o:"";return'<div id="'+e+"-"+t+'" class="editor-modal modal fade '+a+" "+e+'"><div class="modal-dialog" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title">'+r+'</h4></div><div class="modal-body">'+n+'</div><div class="modal-footer">'+d+"</div></div></div></div>"}
...
var rawMixin={methods:{createFieldsRecursively:function(n){var t=[],e=0;for(var r in n)if(n.hasOwnProperty(r)){e+=1;var o="undefined"==typeof n[r].name?r:n[r].name,i={name:o,extra_form_type:n[r].extra_form_type,options:n[r].options,constraints:n[r].constraints};i.active=1===e,"undefined"!=typeof n[r].options.configuration&&(i.options.configuration=this.createFieldsRecursively(n[r].options.configuration)),t.push(i)}return t},formatOptions:function(n){for(var t in n)if(n.hasOwnProperty(t))try{0===n[t].length?delete n[t]:n[t]=JSON.parse(n[t])}catch(e){}return n}}};
