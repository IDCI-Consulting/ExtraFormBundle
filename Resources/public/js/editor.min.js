...
function filterObject(t,e){var a={};for(var o in t)t.hasOwnProperty(o)&&e(t[o])&&(a[o]=t[o]);return a}function generateUniqueId(){return Math.random().toString(36).substr(2,9)}function getLastKey(t){var e=Object.keys(t),a=e.length-1;return e[a]}function createAttributeMapObject(t){for(var e,a=t.attributes,o={},r=0,d=a.length;r<d;r++)e=a[r],o[e.nodeName]=e.nodeValue;return o.value=t.value,o}function createBootstrapModal(t,e,a,o,r,d){var n=d?d:"";return'<div id="'+e+"-"+t+'" class="editor-modal modal fade '+a+" "+e+'"><div class="modal-dialog" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title">'+o+'</h4></div><div class="modal-body">'+r+'</div><div class="modal-footer">'+n+"</div></div></div></div>"}
