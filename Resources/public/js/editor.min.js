...
var jsonOptionMixin={mixins:[optionMixin],data:function(){return{classes:""}},created:function(){"object"==typeof this.value&&(this.data=twigifyJsonString(JSON.stringify(this.value,null,4)),this.setJsonAttemptClass(this.data))},watch:{value:{handler:function(t){"object"==typeof t&&(this.data=twigifyJsonString(JSON.stringify(t,null,4)),this.setJsonAttemptClass(this.data))}}},methods:{onOptionValueChanged:function(t){this.updateOption(t),this.setJsonAttemptClass(t)},setJsonAttemptClass:function(t){if(0===t.indexOf("{")||0===t.indexOf("["))try{JSON.parse(jsonifyTwigStrings(t)),this.classes="fa fa-check success feedback"}catch(s){this.classes="fa fa-exclamation-circle warning feedback"}else this.classes=""}}};
...
var rawModalMixin={methods:{closeModal:function(e){"undefined"!=typeof e&&($(e.target).closest(".modal").modal("hide"),$(e.target).siblings(".json-errors").empty())},displayJsonParseErrors:function(e,r){"undefined"!=typeof e&&$(e.target).siblings(".json-errors").text("There are errors in your json : "+r)}}};
