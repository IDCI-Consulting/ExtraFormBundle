...
function filterObject(t,e){var r={};for(var a in t)t.hasOwnProperty(a)&&e(t[a])&&(r[a]=t[a]);return r}function generateUniqueId(){return Math.random().toString(36).substr(2,9)}function createAttributeMapObject(t){for(var e,r=t.attributes,a={},n=0,u=r.length;n<u;n++)e=r[n],a[e.nodeName]=e.nodeValue;return a.value=t.value,a}function submitForm(t,e){var r=$.ajax({url:t.attr("action"),method:t.attr("method"),data:t.serialize()});r.done(function(t){return e({success:!0,data:t})}),r.fail(function(t){return e({success:!1,data:t})})}
...
var configuredExtraFormType={template:'<div><button @click="createConfiguredField(type)" class="extra-btn" type="button" :class="type.name"><i :class="getFontAwsomeIconClass(type.icon)" aria-hidden="true"></i><span>{{ type.name }}</span><i v-if="configuredFieldEditionAllowed" class="fa fa-trash delete" @click.stop="openDeleteModal"></i></button><modal v-if="modal.show"><h3 slot="header">Delete this configured field<button @click="closeDeleteModal" type="button" class="close" aria-label="Close">&times;</button></h3><div slot="body" v-html="modal.content"></div><div slot="footer"><button @click="deleteConfiguredType(type)" type="button" class="extra-btn" aria-label="Save">Delete</button></div></modal></div>',props:["type"],data:function(){return{modal:{show:!1,content:'<div><i class="'+this.getFontAwsomeIconClass(this.type.icon)+'" aria-hidden="true"></i></div><div>Type: <strong>'+this.type.form_type+"</strong></div><div>Name: <strong>"+this.type.name+"</strong></div>"}}},computed:{configuredFieldEditionAllowed:function(){return this.$store.getters.configuredFieldEditionAllowed}},mixins:[fontAwesomeIconMixin],methods:{openDeleteModal:function(){this.modal.show=!0},closeDeleteModal:function(){this.modal.show=!1},deleteConfiguredType:function(e){this.$emit("delete",e)},createConfiguredField:function(e){this.$emit("created",e)}}};
...
window.loadExtraFormEditor=function(){extraQuery("textarea.extra-form-editor").each(function(e){function a(){var e=extraQuery(".editor-simple");e.on("click",".field-options > label",function(e){e.stopImmediatePropagation(),extraQuery(this).parent().toggleClass("show")}),e.on("click",".field-constraint-options > label",function(e){e.stopImmediatePropagation(),extraQuery(this).parent().toggleClass("show")})}function o(){extraQuery(document).on("change",'.extra-form-inputs-required input[required="required"]',function(){extraQuery(this).val()?extraQuery(this).css({"border-color":"#cccccc","background-color":"#ffffff"}):extraQuery(this).css({"border-color":"#c9302c","background-color":"#f3d9d9"})})}function t(e,a){extraQuery(document).on("click","button.trigger-"+e+"-"+a,function(o){o.preventDefault();var t=extraQuery("#"+e+"-"+a);"overview-modal"!==e&&(t=t.first()),t.modal("show")})}function i(e){var a="."+e+" .modal-body button.close-modal, ."+e+" .modal-footer > button.close-modal, ."+e+" .modal-header > button.close";extraQuery(document).on("click",a,function(e){e.preventDefault(),extraQuery(this).closest(".modal").modal("hide")})}function d(a){function o(o){var t=extraQuery("#raw-mode-modal-"+e+" textarea").first().val(),i=extraQuery.ajax({url:a,method:"POST",data:{overview:{configuration:t}}});i.done(function(e){return o({success:!0,data:e})}),i.fail(function(e){return o({success:!1,data:e})})}extraQuery(document).on("click","button.trigger-overview-modal-"+e,function(){setTimeout(function(){o(function(a){a.success?extraQuery("#overview-modal-"+e+" .modal-body").replaceWith('<div class="modal-body">'+a.data+"</div>"):extraQuery("#overview-modal-"+e+" .modal-body").replaceWith('<div class="modal-body"><div>'+a.data.responseText+"</div></div>")})},800)})}function r(){extraQuery(document).on("click","#overview-modal-"+e+" form button[type='submit']",function(a){a.preventDefault(),n(e);var o=extraQuery(this).closest("form");setTimeout(function(){submitForm(o,function(a){a.success?a.data&&extraQuery("#overview-modal-"+e+" .modal-body").replaceWith('<div class="modal-body">'+a.data+"</div>"):extraQuery("#overview-modal-"+e+" .modal-body").replaceWith('<div class="modal-body"><div>'+a.data.responseText+"</div></div>")})},800)})}function l(){extraQuery(document).on("hidden.bs.modal","#overview-modal-"+e,function(){n(e)})}function n(){extraQuery("#overview-modal-"+e+" .modal-body").replaceWith('<div class="modal-body"><div style="text-align: center;"><i class="fa fa-cog fa-spin fa-3x fa-fw"></i></div></div>')}function s(e,a,o,t,i,d){var r=o?"modal-fullscreen":"",l=d?d:"";return'<div id="'+a+"-"+e+'" class="modal fade '+r+" "+a+'"><div class="modal-dialog" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title">'+t+'</h4></div><div class="modal-body">'+i+'</div><div class="modal-footer">'+l+"</div></div></div></div>"}function c(){return s(e,"raw-mode-modal",!0,"Editor in raw mode",'<editor-raw :fields="fields" @generated="updateFields"></editor-raw><br>')}function u(){return s(e,"simple-visual-mode-modal",!0,"Simple visual mode",'<editor-simple :fields="fields"></editor-simple>',"<em>All your changes are automatically saved</em>")}function m(){return s(e,"advanced-visual-mode-modal",!0,"Advanced visual mode",'<editor-advanced :fields="fields"></editor-advanced>','<button class="btn btn-primary trigger-overview-modal-'+e+'">Display the overview <i class="fa fa-eye"></i></button><em>All your changes are automatically saved</em>')}function v(){return s(e,"extra-form-inputs-required overview-modal",!1,"Overview",'<div style="text-align: center;"><i class="fa fa-cog fa-spin fa-3x fa-fw"></i></div>')}var f=createAttributeMapObject(this),y="editorComponent"+e,b=f["data-available-modes"].split("__"),p=window[f["data-configuration-variable"]],x=c(e),g='<button class="trigger-raw-mode-modal-'+e+'">Raw mode</button>',h="",w="",Q="",k="",E="";b.indexOf("simple")>-1&&(h=u(e),w='<button class="trigger-simple-visual-mode-modal-'+e+'">Simple visual mode</button>'),b.indexOf("advanced")>-1&&(Q=m(e),k=v(e),E='<button class="trigger-advanced-visual-mode-modal-'+e+'">Advanced visual mode</button>'),extraQuery(this).after('<div class="modal-buttons">'+w+" "+E+" "+g+"</div>");var _=extraQuery("body");_.append('<div id="'+y+'">'+x+h+Q+k+"</div>"),this.style.display="none";var A=["simple-visual-mode-modal","advanced-visual-mode-modal","raw-mode-modal","overview-modal"];A.forEach(function(a){t(a,e)}),A.forEach(function(e){i(e)}),d(p.extra_form_editor_overview_url,e),l(e),r(e),o(),a(),triggerVueEditor("#"+y,f,p)})};