...
var rawModalMixin={methods:{updateInitialTextareaValue:function(){this.textarea.id&&(document.getElementById(this.textarea.id).value=this.raw)},closeModal:function(e){"undefined"!=typeof e&&($(e.target).closest(".modal").modal("hide"),$(e.target).siblings(".json-errors").empty())},displayJsonParseErrors:function(e,t){"undefined"!=typeof e&&$(e.target).siblings(".json-errors").text("There are errors in your json : "+t)}}};
...
Vue.component("form-editor-raw",{template:'<div class="extra-form-editor raw-mode"><textarea :data-textarea-id="textarea.id" v-model="raw" :name="textarea.name" ></textarea><div class="json-errors"></div><button @click.prevent="generateFields">Fill the visual mode form fields from this json</button></div>',props:["fields"],data:function(){return{raw:"",textarea:this.$store.state.formProperties}},mixins:[rawMixin,rawModalMixin],created:function(){""!==this.textarea.value&&(this.raw=this.textarea.value,this.generateFields())},watch:{fields:{handler:function(e){this.raw=this.generateRaw(e),this.updateInitialTextareaValue()},deep:!0}},methods:{generateFields:function(e){var t=[];try{var a=JSON.parse(transformRawToJson(this.raw));t=this.createFieldsRecursively(a),this.$emit("generated",t),this.closeModal(e)}catch(r){this.displayJsonParseErrors(e,r)}},generateRaw:function(e){var t=this.createExtraFormRawRecursively(e);return transformJsonToRaw(JSON.stringify(t,null,4))}}});
...
window.loadExtraFormEditors=function(){$("textarea.extra-form-editor").each(function(e){function o(){var e=$(".editor-simple");e.on("click",".field-options > label",function(e){e.stopImmediatePropagation(),$(this).parent().toggleClass("show")}),e.on("click",".field-constraint-options > label",function(e){e.stopImmediatePropagation(),$(this).parent().toggleClass("show")})}function a(e,o){$(document).on("click","button.trigger-"+e+"-"+o,function(a){a.preventDefault();var t=$("#"+e+"-"+o);"overview-modal"!==e&&(t=t.first()),t.modal("show")})}function t(e){var o="."+e+" .modal-body button.close-modal, ."+e+" .modal-footer > button.close-modal, ."+e+" .modal-header > button.close";$(document).on("click",o,function(e){e.preventDefault(),$(this).closest(".modal").modal("hide")})}function i(o){function a(a){var t=$("#raw-mode-modal-"+e+" textarea").first().val(),i=$.ajax({url:o,method:"POST",data:{overview:{configuration:t}}});i.done(function(e){return a({success:!0,data:e})}),i.fail(function(e){return a({success:!1,data:e})})}$(document).on("click","button.trigger-overview-modal-"+e,function(){setTimeout(function(){a(function(o){o.success?$("#overview-modal-"+e+" .modal-body").replaceWith('<div class="modal-body">'+o.data+"</div>"):$("#overview-modal-"+e+" .modal-body").replaceWith('<div class="modal-body"><div>'+o.data.responseText+"</div></div>")})},800)})}function d(){$(document).on("click","#overview-modal-"+e+" form button[type='submit']",function(o){o.preventDefault(),r(e);var a=$(this).closest("form");setTimeout(function(){l(a,function(o){o.success?o.data&&$("#overview-modal-"+e+" .modal-body").replaceWith('<div class="modal-body">'+o.data+"</div>"):$("#overview-modal-"+e+" .modal-body").replaceWith('<div class="modal-body"><div>'+o.data.responseText+"</div></div>")})},800)})}function n(){$(document).on("hidden.bs.modal","#overview-modal-"+e,function(){r(e)})}function r(){$("#overview-modal-"+e+" .modal-body").replaceWith('<div class="modal-body"><div style="text-align: center;"><i class="fa fa-cog fa-spin fa-3x fa-fw"></i></div></div>')}function l(e,o){var a=$.ajax({url:e.attr("action"),method:e.attr("method"),data:e.serialize()});a.done(function(e){return o({success:!0,data:e})}),a.fail(function(e){return o({success:!1,data:e})})}function s(){return createBootstrapModal(e,"raw-mode-modal","modal-fullscreen","Editor in raw mode",'<form-editor-raw :fields="fields" @generated="updateFields"></form-editor-raw><br>')}function c(){return createBootstrapModal(e,"simple-visual-mode-modal","modal-fullscreen","Simple visual mode",'<form-editor-simple :fields="fields"></form-editor-simple>',"<em>All your changes are automatically saved</em>")}function m(){return createBootstrapModal(e,"advanced-visual-mode-modal","modal-fullscreen","Advanced visual mode",'<form-editor-advanced :fields="fields"></form-editor-advanced>','<button class="btn btn-primary trigger-overview-modal-'+e+'">Display the overview <i class="fa fa-eye"></i></button><em>All your changes are automatically saved</em>')}function u(){return createBootstrapModal(e,"overview-modal","extra-form-inputs-required","Overview",'<div style="text-align: center;"><i class="fa fa-cog fa-spin fa-3x fa-fw"></i></div>')}var v="editorComponent"+e;if(!document.getElementById(v)){var f=createAttributeMapObject(this),p=f["data-available-modes"].split("__"),b=window[f["data-configuration-variable"]],w=s(e),g='<button class="trigger-raw-mode-modal-'+e+'">Raw mode</button>',h="",y="",x="",E="",k="";p.indexOf("simple")>-1&&(h=c(e),y='<button class="trigger-simple-visual-mode-modal-'+e+'">Simple visual mode</button>'),p.indexOf("advanced")>-1&&(x=m(e),E=u(e),k='<button class="trigger-advanced-visual-mode-modal-'+e+'">Advanced visual mode</button>'),$(this).after('<div class="modal-buttons">'+y+" "+k+" "+g+"</div>");var _=$("body");_.append('<div id="'+v+'">'+w+h+x+E+"</div>"),this.style.display="none";var A=["simple-visual-mode-modal","advanced-visual-mode-modal","raw-mode-modal","overview-modal"];A.forEach(function(o){a(o,e)}),A.forEach(function(e){t(e)}),i(b.extra_form_editor_overview_url,e),n(e),d(e),o(),triggerVueEditor("#"+v,f,b),colorEmptyRequiredInputs(v,".extra-form-inputs-required")}})};