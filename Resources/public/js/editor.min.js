...
JsonToTwigTransformer={toJson:function(e){function r(e){return e.replace(/\\/g,"\\\\").replace(/"/g,'\\"')}function n(e){return e.replace(/([^\\])"/g,'$1\\"').replace(/\r?\n|\r/g," ").replace(/ {2,}/g," ")}var c=/{{(.*)?}}/g,a=/\[{%([\s\S]*.*)%}\]/g,g=/("([\w.|]*)"): (\[{%([\s\S]*.*)%}\])/g;return e.replace(c,r).replace(a,n).replace(g,'$1: "$3"')},toRaw:function(e){function r(e){return e.replace(/\\\\/g,"\\").replace(/\\"/g,'"')}function n(e){var r=e.replace(/\\"/g,'"').replace(/\\\\'/g,"\\'");return r.substring(1,r.length-1)}var c=/{{(.*)?}}/g,a=/"\[{%(.*)%}\]"/g;return e.replace(c,r).replace(a,n)}};
