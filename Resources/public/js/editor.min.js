...
window.loadExtraFormEditor=function(){$("textarea.extra-form-editor").each(function(o){function e(){var o=$(".editor-simple");o.on("click",".field-options > label",function(o){o.stopImmediatePropagation(),$(this).parent().toggleClass("show")}),o.on("click",".field-constraint-options > label",function(o){o.stopImmediatePropagation(),$(this).parent().toggleClass("show")})}function a(){$(document).on("change",'input[required="required"]',function(){$(this).val()?$(this).css({"border-color":"#cccccc","background-color":"#ffffff"}):$(this).css({"border-color":"#c9302c","background-color":"#f3d9d9"})})}function i(o,e){$(document).on("click","button.trigger-"+o+"-"+e,function(a){a.preventDefault();var i=$("#"+o+"-"+e);"overview-modal"!==o&&(i=i.first()),i.modal("show")})}function t(o){var e="."+o+" .modal-body button.close-modal, ."+o+" .modal-footer > button.close-modal, ."+o+" .modal-header > button.close";$(document).on("click",e,function(o){o.preventDefault(),$(this).closest(".modal").modal("hide")})}function d(e){function a(a){var i=$("#raw-mode-modal-"+o+" textarea").first().val(),t=$.ajax({url:e,method:"POST",data:{overview:{configuration:i}}});t.done(function(o){return a({success:!0,data:o})}),t.fail(function(o){return a({success:!1,data:o})})}$(document).on("click","button.trigger-overview-modal-"+o,function(){setTimeout(function(){a(function(e){e.success?$("#overview-modal-"+o+" .modal-body").replaceWith('<div class="modal-body">'+e.data+"</div>"):$("#overview-modal-"+o+" .modal-body").replaceWith('<div class="modal-body"><div>'+e.data.responseText+"</div></div>")})},800)})}function l(){$(document).on("click","#overview-modal-"+o+" form button[type='submit']",function(e){e.preventDefault(),r(o);var a=$(this).closest("form");setTimeout(function(){submitForm(a,function(e){e.success?e.data&&$("#overview-modal-"+o+" .modal-body").replaceWith('<div class="modal-body">'+e.data+"</div>"):$("#overview-modal-"+o+" .modal-body").replaceWith('<div class="modal-body"><div>'+e.data.responseText+"</div></div>")})},800)})}function n(){$(document).on("hidden.bs.modal","#overview-modal-"+o,function(){r(o)})}function r(){$("#overview-modal-"+o+" .modal-body").replaceWith('<div class="modal-body"><div style="text-align: center;"><i class="fa fa-cog fa-spin fa-3x fa-fw"></i></div></div>')}function s(o,e,a,i,t,d){var l=a?"modal-fullscreen":"",n=d?d:"";return'<div id="'+e+"-"+o+'" class="modal fade '+l+" "+e+'"><div class="modal-dialog" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title">'+i+'</h4></div><div class="modal-body">'+t+'</div><div class="modal-footer">'+n+"</div></div></div></div>"}function c(){return s(o,"raw-mode-modal",!0,"Editor in raw mode",'<editor-raw :fields="fields" @generated="updateFields"></editor-raw><br>')}function m(){return s(o,"simple-visual-mode-modal",!0,"Simple visual mode",'<editor-simple :fields="fields"></editor-simple>',"<em>All your changes are automatically saved</em>")}function u(){return s(o,"advanced-visual-mode-modal",!0,"Advanced visual mode",'<editor-advanced :fields="fields"></editor-advanced>','<button class="btn btn-primary trigger-overview-modal-'+o+'">Display the overview <i class="fa fa-eye"></i></button><em>All your changes are automatically saved</em>')}function v(){return s(o,"overview-modal",!1,"Overview",'<div style="text-align: center;"><i class="fa fa-cog fa-spin fa-3x fa-fw"></i></div>')}var f=createAttributeMapObject(this),b="editorComponent"+o,p=f["data-available-modes"].split("__"),g=window[f["data-configuration-variable"]],h=c(o),w='<button class="trigger-raw-mode-modal-'+o+'">Raw mode</button>',y="",x="",k="",E="",_="";p.indexOf("simple")>-1&&(y=m(o),x='<button class="trigger-simple-visual-mode-modal-'+o+'">Simple visual mode</button>'),p.indexOf("advanced")>-1&&(k=u(o),E=v(o),_='<button class="trigger-advanced-visual-mode-modal-'+o+'">Advanced visual mode</button>'),$(this).after('<div class="modal-buttons">'+x+" "+_+" "+w+"</div>");var A=$("body");A.append('<div id="'+b+'">'+h+y+k+E+"</div>"),this.style.display="none";var O=["simple-visual-mode-modal","advanced-visual-mode-modal","raw-mode-modal","overview-modal"];O.forEach(function(e){i(e,o)}),O.forEach(function(o){t(o)}),d(g.extra_form_editor_overview_url,o),n(o),l(o),a(),e(),triggerVueEditor("#"+b,f,g)})};