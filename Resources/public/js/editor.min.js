...
function filterObject(t,r){var e={};for(var n in t)t.hasOwnProperty(n)&&r(t[n])&&(e[n]=t[n]);return e}function generateUniqueId(){return Math.random().toString(36).substr(2,9)}function createAttributeMapObject(t){for(var r,e=t.attributes,n={},a=0,u=e.length;a<u;a++)r=e[a],n[r.nodeName]=r.nodeValue;return n}function submitForm(t,r){var e=$.ajax({url:t.attr("action"),method:t.attr("method"),data:t.serialize()});e.done(function(t){return r({success:!0,data:t})}),e.fail(function(t){return r({success:!1,data:t})})}
var optionMixin={props:["option","name","value"],data:function(){return{data:this.option.options.data}},created:function(){"undefined"!=typeof this.value&&("string"!=typeof this.value?this.data=JSON.stringify(this.value):this.data=this.value)},watch:{value:{handler:function(t){"string"!=typeof t?this.data=JSON.stringify(t):this.data=t}}},methods:{updateOption:function(t){this.data=t,this.$emit("changed",{name:this.name,value:t})},setJsonAttemptClass:function(t){if(0===t.indexOf("{")||0===t.indexOf("["))try{JSON.parse(t),this.classes="fa fa-check success feedback"}catch(a){this.classes="fa fa-exclamation-circle warning feedback"}else this.classes=""}}};
...
var typesSelectbox={template:'<select v-bind:value="value" v-on:change="updateValue($event.target.value)" v-model="selected"><option v-for="type in types" :value="type.name">{{ type.name }}</option></select>',props:["value"],data:function(){return{selected:this.value,types:[]}},mixins:[httpMixin],mounted:function(){this.getExtraFormTypes()},watch:{value:{handler:function(e){this.selected=e}}},methods:{updateValue:function(e){this.$emit("input",e)},getExtraFormTypes:function(){var e=this.$store.getters.extraFormTypesApiUrl,t=this;this.handleGetRequest(e,function(e){t.types=e.filter(function(e){return e["abstract"]===!1}),"initial"===t.selected&&(t.selected=t.types[0].name),t.$emit("input",t.selected)})}}};
...
Vue.component("editor-advanced",{template:'<div class="editor-advanced row"><extra-form-types @created="addField" class="extra-form-types col-md-3 col-lg-3"></extra-form-types><extra-form-fields :fields="fields" class="extra-form-fields col-md-4 col-lg-3"></extra-form-fields><extra-form-fields-configuration :fields="fields" class="extra-form-fields-configuration col-md-5 col-lg-6"></extra-form-fields-configuration></div>',props:["fields"],components:{"extra-form-types":extraFormTypes,"extra-form-fields":extraFormFields,"extra-form-fields-configuration":extraFormFieldsConfiguration},methods:{addField:function(e){this.resetActiveClasses(),e.active=!0,this.fields.push(e)},resetActiveClasses:function(){for(var e=0,s=this.fields.length;e<s;e++)this.$set(this.fields[e],"active",!1)}}});
Vue.component("editor-raw",{template:'<div><textarea :data-textarea-id="textarea.id" v-model="raw" :name="textarea.name" style="width: 100%; height: 300px;"></textarea><button class="close-modal" @click.prevent="generateFields">Fill the visual mode form fields from this json</button></div>',props:["fields"],data:function(){return{raw:"",textarea:this.$store.state.formProperties}},mixins:[fieldsMixin],created:function(){try{""!==this.textarea.value&&(this.raw=this.textarea.value,this.generateFields())}catch(t){console.error("Json parsing error")}},watch:{fields:{handler:function(t){this.raw=this.generateOutput(t),this.updateInitialTextareaValue()},deep:!0}},methods:{updateInitialTextareaValue:function(){document.getElementById(this.textarea.id).value=this.raw},generateFields:function(){var t=[];try{var e=JSON.parse(this.raw);t=this.createFieldsRecursively(e),this.$emit("generated",t)}catch(r){console.error("Json parsing error")}},generateOutput:function(t){var e=this.createOutputRecursively(t);return JSON.stringify(e,null,4)},createOutputRecursively:function(t){for(var e=JSON.parse(JSON.stringify(t)),r={},a=0,i=e.length;a<i;a++){var n=e[a],o=n.name;r[o]={},r[o].extra_form_type=n.extra_form_type,r[o].constraints=n.constraints;var s=n.options;for(var u in s)if(s.hasOwnProperty(u))try{0===s[u].length?delete s[u]:s[u]=JSON.parse(s[u])}catch(c){}r[o].options=s,"undefined"!=typeof n.options.configuration&&(0===n.options.configuration.length?delete r[o].options.configuration:r[o].options.configuration=this.createOutputRecursively(r[o].options.configuration),r[o].constraints=n.constraints)}return r}}});
function triggerExtraFormBundleEditor(e,r,n){Vue.component("Multiselect",VueMultiselect["default"]),Vue.use(VueResource);var t=new Vuex.Store({state:{configuration:n,formProperties:r,configuredTypes:[],types:[],apiCache:{}},getters:{editorId:function(e){return e.configuration.editorId},configuredFieldEditionAllowed:function(e){return e.configuration.allow_configured_type_edition},configuredExtraFormTypesApiUrl:function(e){return e.configuration.api_url.get_configured_extra_form_types},extraFormTypesApiUrl:function(e){return e.configuration.api_url.get_extra_form_types},postConfiguredExtraFormTypesApiUrl:function(e){return e.configuration.api_url.post_configured_extra_form_types},putConfiguredExtraForTypesApiUrl:function(e){return function(r){return e.configuration.api_url.put_configured_extra_form_types.replace("XNAME",r)}},deleteConfiguredExtraForTypesApiUrl:function(e){return function(r){return e.configuration.api_url.delete_configured_extra_form_types.replace("XNAME",r)}},extraFormTypeOptionsApiUrl:function(e){return function(r){return e.configuration.api_url.get_extra_form_type_options.replace("XTYPE",r)}},extraFormConstraintsApiUrl:function(e){return e.configuration.api_url.get_extra_form_constraints},getCachedResource:function(e){return function(r){return e.apiCache[r]}},getConfiguredTypes:function(e){return e.configuredTypes},getTypes:function(e){return e.types}},mutations:{cache:function(e,r){e.apiCache[r.api_url]=r.api_response},setConfiguredTypes:function(e,r){e.configuredTypes=r},addConfiguredType:function(e,r){e.configuredTypes.push(r)},removeConfiguredType:function(e,r){e.configuredTypes.splice(r,1)},updateConfiguredType:function(e,r){for(var n=0,t=e.configuredTypes.length;n<t;n++)if(e.configuredTypes[n].name===r.name)return e.configuredTypes.splice(n,1),void e.configuredTypes.push(r)},setTypes:function(e,r){e.types=r}}});new Vue({el:e,store:t,data:{fields:[]},mixins:[httpMixin],methods:{updateFields:function(e){this.$set(this,"fields",e)}}})}
function showModalOnClick(e,o){$(document).on("click","button.trigger-"+e+"-"+o,function(a){a.preventDefault();var d=$("#"+e+"-"+o);"overview-modal"!==e&&(d=d.first()),d.modal("show")})}function hideModalOnClick(e){var o="."+e+" .modal-body button.close-modal, ."+e+" .modal-footer > button.close-modal, ."+e+" .modal-header > button.close";$(document).on("click",o,function(e){e.preventDefault(),$(this).closest(".modal").modal("hide")})}function getFormOverviewOnClick(e,o){function a(e,a){var d=$("#raw-mode-modal-"+o+" textarea").first().val(),i=$.ajax({url:e,method:"POST",data:{overview:{configuration:d}}});i.done(function(e){return a({success:!0,data:e})}),i.fail(function(e){return a({success:!1,data:e})})}$(document).on("click","button.trigger-overview-modal-"+o,function(){setTimeout(function(){a(e,function(e){e.success?$("#overview-modal-"+o+" .modal-body").replaceWith('<div class="modal-body">'+e.data+"</div>"):$("#overview-modal-"+o+" .modal-body").replaceWith('<div class="modal-body"><div>'+e.data.responseText+"</div></div>")})},800)})}function submitFormOverviewOnClick(e){$(document).on("click","#overview-modal-"+e+" form button",function(o){o.preventDefault(),resetFormOverviewModal(e);var a=$(this).closest("form");setTimeout(function(){submitForm(a,function(o){o.success?o.data&&$("#overview-modal-"+e+" .modal-body").replaceWith('<div class="modal-body">'+o.data+"</div>"):$("#overview-modal-"+e+" .modal-body").replaceWith('<div class="modal-body"><div>'+o.data.responseText+"</div></div>")})},800)})}function resetFormOverviewModalOnClose(e){$(document).on("hidden.bs.modal","#overview-modal-"+e,function(){resetFormOverviewModal(e)})}function resetFormOverviewModal(e){$("#overview-modal-"+e+" .modal-body").replaceWith('<div class="modal-body"><div style="text-align: center;"><i class="fa fa-cog fa-spin fa-3x fa-fw"></i></div></div>')}function createModal(e,o,a,d,i,t){return a=a?"modal-fullscreen":"",t=t?t:"",'<div id="'+o+"-"+e+'" class="modal fade '+a+" "+o+'"><div class="modal-dialog" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title">'+d+'</h4></div><div class="modal-body">'+i+'</div><div class="modal-footer">'+t+"</div></div></div></div>"}function createRawModal(e){return createModal(e,"raw-mode-modal",!0,"Editor in raw mode",'<editor-raw :fields="fields" @generated="updateFields"></editor-raw><br>')}function createSimpleModal(e){return createModal(e,"simple-visual-mode-modal",!0,"Simple visual mode",'<editor-simple :fields="fields"></editor-simple>',"<em>All your changes are automatically saved</em>")}function createAdvancedModal(e){return createModal(e,"advanced-visual-mode-modal",!0,"Advanced visual mode",'<editor-advanced :fields="fields"></editor-advanced>','<button class="btn btn-primary trigger-overview-modal-'+e+'">Display the overview <i class="fa fa-eye"></i></button><em>All your changes are automatically saved</em>')}function createOverviewModal(e){return createModal(e,"overview-modal",!1,"Overview",'<div style="text-align: center;"><i class="fa fa-cog fa-spin fa-3x fa-fw"></i></div>')}$(window).on("load",function(){$("textarea.extra-form-editor").each(function(e){var o=createAttributeMapObject(this);o.value=this.value;var a="editorComponent"+e,d=o["data-available-modes"].split("__"),i=window[o["data-configuration-variable"]],t=createRawModal(e),l='<button class="trigger-raw-mode-modal-'+e+'">Raw mode</button>',r="",n="";d.indexOf("simple")>-1&&(r=createSimpleModal(e),n='<button class="trigger-simple-visual-mode-modal-'+e+'">Simple visual mode</button>');var c="",s="",v="";d.indexOf("advanced")>-1&&(c=createAdvancedModal(e),s=createOverviewModal(e),v='<button class="trigger-advanced-visual-mode-modal-'+e+'">Advanced visual mode</button>'),$(this).after('<div class="modal-buttons">'+n+" "+v+" "+l+"</div>"),function(){var e=$("body");e.append('<div id="'+a+'">'+t+r+c+s+"</div>")}(),this.style.display="none";var m=["simple-visual-mode-modal","advanced-visual-mode-modal","raw-mode-modal","overview-modal"];m.forEach(function(o){showModalOnClick(o,e)}),m.forEach(function(e){hideModalOnClick(e)}),getFormOverviewOnClick(i.extra_form_editor_overview_url,e),resetFormOverviewModalOnClose(e),submitFormOverviewOnClick(e),triggerExtraFormBundleEditor("#"+a,o,i)});var e=$(".editor-simple");e.on("click",".field-options > label",function(e){e.stopImmediatePropagation(),$(this).parent().toggleClass("show")}),e.on("click",".field-constraint-options > label",function(e){e.stopImmediatePropagation(),$(this).parent().toggleClass("show")}),$(document).on("change",'input[required="required"]',function(){$(this).val()?$(this).css({"border-color":"#cccccc","background-color":"#ffffff"}):$(this).css({"border-color":"#c9302c","background-color":"#f3d9d9"})})});