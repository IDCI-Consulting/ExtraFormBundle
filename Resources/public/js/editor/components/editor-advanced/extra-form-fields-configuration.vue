...
import editorAdvancedFieldOptions from './field-options.vue';
import editorAdvancedFieldConstraints from './field-constraints.vue';
import editorAdvancedNewFieldConstraint from './new-field-constraint.vue';
