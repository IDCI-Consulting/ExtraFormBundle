...
/******/ 		}
/******/ 		script.src = __webpack_require__.p + "" + ({"0":"bootstrap-vue-editor"}[chunkId]||chunkId) + ".vendor.js";
...
/******/ 	__webpack_require__.p = "/bundles/idciextraform/js/";
/******/
...
function loadExtraFormEditors () {
  ...
  __WEBPACK_IMPORTED_MODULE_1_jquery___default.a('textarea.extra-form-editor').each(function (index) {
    ...
    Promise.all([
      ...
      var formProperties = __WEBPACK_IMPORTED_MODULE_0__utils_utils__["createAttributeMapObject"](textarea);
      ...
      __WEBPACK_IMPORTED_MODULE_0__utils_utils__["colorEmptyRequiredInputs"](editorComponentId, 'extra-form-inputs-required');
      ...
      function createRawModal() {
        return __WEBPACK_IMPORTED_MODULE_0__utils_utils__["createBootstrapModal"](
          index,
          'raw-mode-modal',
          'modal-fullscreen',
          'Editor in raw mode',
